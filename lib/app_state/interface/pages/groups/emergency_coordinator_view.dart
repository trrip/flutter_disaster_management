...
class EmergencyCoordinatorView extends StatefulWidget {
  final User user;

  const EmergencyCoordinatorView({Key key, @required this.user})
      : super(key: key);

  @override
  _EmergencyCoordinatorViewState createState() =>
      _EmergencyCoordinatorViewState();
}

class _EmergencyCoordinatorViewState extends State<EmergencyCoordinatorView> {
  ...
  LatLng cameraFocus;
  StreamController<Null> streamController = StreamController<Null>();
              ...
              Marker(
                builder: (context) {
                  return IconButton(
                    ...
                    onPressed: () {
                      navigateToPoint(LatLng(point.latitude, point.longitude));
                    },
                  );
                },
